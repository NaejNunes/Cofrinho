...
public class SelecionarPersonagem : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        if (GUI.Button(new Rect(23, (Screen.height - 110), 70, 70), ""))
        {
            personagemAtual--;
        ...
        if (GUI.Button(new Rect(Screen.width - 90, (Screen.height - 110), 70, 70), ""))
        {
            personagemAtual++;
        ...
        GUI.Label(new Rect((Screen.width - 100) / 2, 20, 200, 50), "");
